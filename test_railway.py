#!/usr/bin/env python3
"""Test Railway webhook directly."""

import requests

def test_railway_webhook():
    """Test the Railway webhook with proper Twilio data."""
    
    url = "https://web-production-2b37.up.railway.app/api/voice/webhook"
    
    # Proper Twilio webhook data (using test values)
    data = {
    ...
    print("🧪 Testing Railway Voice Webhook")
    print(f"URL: {url}")
    print(f"Data: {data}")
    print("-" * 50)
